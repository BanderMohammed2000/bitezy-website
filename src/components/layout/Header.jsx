...
function Header() {
  return (
    <>
      ...
      {/* mobile menu */}
      {/* bg-[#fef9f7] */}
      {/* <nav className="block lg:hidden bg-white shadow-[0_20px_60px_rgba(0,0,0,0.12)] absolute left-0 top-0 h-screen w-[80%] z-30">
        <div className="container mx-auto py-6 px-4">
          ...
          <ul className="mt-14 space-y-4">
            <li>
              <a
                href="#menu"
                className="flex items-center justify-between bg-[#feede2] p-3 rounded-lg"
              >
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-lg font-medium text-blackSoft capitalize">
                    menu
                  </span>
                </div>
                <img
