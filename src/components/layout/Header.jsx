...
function Header() {
  ...
  // const aStyle =
  //   "flex items-center justify-between bg-[#feede2] p-3 rounded-lg";

  // const spanStyle = "text-lg font-medium text-blackSoft capitalize";
  ...
  return (
    <>
      ...
      {/* bg-[#fef9f7] */}
      <nav
        className={`${isMenuOpen ? "block" : "hidden"} lg:hidden bg-white shadow-[0_20px_60px_rgba(0,0,0,0.12)] absolute left-0 top-0 h-screen w-[80%] z-30`}
      >
        <div className="container mx-auto py-6 px-4">
          <div className="flex justify-between items-center">
            ...
            {/* <img src={close} alt="X Icon" className="w-6 h-6" /> */}
              ...
              >
                <div className="flex items-center space-x-4">
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    {/* <title xmlns="">bowl-food-outline</title> */}
                    <path
                      fill="none"
              ...
              >
                <div className="flex items-center space-x-4">
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    {/* <title xmlns="">category-outline-rounded</title> */}
                    <path
            ...
            <li>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  >
                    {/* <title xmlns="">team-outlined</title> */}
                    <path
              ...
              >
                <div className="flex items-center space-x-4">
                  <svg
                    ...
                    viewBox="0 0 26 26"
                  >
                    {/* <title xmlns="">message-outline</title> */}
                    <path
